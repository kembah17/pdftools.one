  ...
  return (
    <div className="page-container">
      <div className="text-center py-20">
        <h1 className="text-8xl font-bold text-text-light/30 dark:text-text-dark-muted/30 mb-4">404</h1>
        <h2 className="text-2xl font-bold text-text dark:text-text-dark mb-4">
          Page Not Found
        </h2>
        <p className="text-text-light dark:text-text-dark-muted mb-8 max-w-md mx-auto">
